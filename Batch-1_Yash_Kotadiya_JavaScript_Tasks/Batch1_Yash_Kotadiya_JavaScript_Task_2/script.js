...
function addBtn() {
    ...
    let insert_row = `<td scope="row" class="pt-3 first_td">${chance}</td>
    ...
    <td><button onclick="removeBtn(this)" class="btn btn-outline-warning">Remove</button></td>`
